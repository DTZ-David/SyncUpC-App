...
class BookmarksService {
  Future<List<EventModel>> getSavedEvents(String token) async {
    final url = Uri.parse('${AppConfig.baseUrl}/bookmark/getallsavedevents');
  ...
  Future<void> addEventFav(String token, String eventId) async {
    final url = Uri.parse('${AppConfig.baseUrl}/bookmark/addeventotofavs');
  ...
  Future<void> removeEventSaved(String token, String eventId) async {
    final url = Uri.parse('${AppConfig.baseUrl}/bookmark/removesaveevent');
