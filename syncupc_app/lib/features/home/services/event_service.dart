...
class EventService {
  Future<List<EventModel>> getEventsForU(String token) async {
    final url = Uri.parse('${AppConfig.baseUrl}/event/getalleventsforstudents');
  ...
  Future<List<EventModel>> getAllEvents(String token) async {
    final url = Uri.parse('${AppConfig.baseUrl}/event/getallevents');
